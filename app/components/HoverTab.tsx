...
export default function HoverTab({ items }: HoverTabProps) {
  ...
  const updateTabPosition = useCallback((index: number, tabWidth: number) => {
    ...
    setTabPosition({
      left: Math.max(0, Math.min(leftPosition, containerRect.width - tabWidth)),
      top: itemRect.height + 20 // Increased gap
    });
  }, []);
  ...
  const getAccentColor = (index: number) => {
    const colors = ['var(--emerald)', 'var(--violet)', 'var(--amber)', 'var(--crimson)'];
          ...
          return (
            ...
            >
              <span 
                ...
                style={{ 
                  color: isActive ? accentColor : 'var(--text-1)',
          ...
          <div className="relative">
            ...
            >
              ...
              <div 
                ...
                style={{ 
                  background: `linear-gradient(90deg, ${getAccentColor(activeIndex)} 0%, transparent 100%)`,
                  height: '4px',
                }}
              />
