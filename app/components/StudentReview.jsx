...
export default function StudentReviews() {
  return (
    <section className="bg-[rgb(255,250,245)] py-20 px-6 lg:px-20 relative overflow-hidden">
      {/* Header */}
      <h2 className="text-black text-4xl lg:text-5xl font-bold text-center mb-12 ppe-header">
        Student Reviews
      </h2>
          ...
          <div className="marquee flex gap-6">
            {[...reviews, ...reviews].map((rev, idx) => (
              ...
              >
                ...
                {/* Review text */}
                <p className="text-gray-800 text-lg leading-relaxed mb-4 ppe-text">
                  {rev.review}
                </p>

                {/* Name + line */}
                <p className="font-bold text-black mb-1 ppe-header">
                  {rev.name}
                </p>
